...
We thank the reviewers for many thoughtful comments.  Indeed, there are 19 pages worth of (formatted) reviewer comments below, and our replies take another 20 pages, yielding this long 39 page document.
...
{In our model that basal melt rate affects both $W_{til}$ and $W$, through conservation of mass, and this results in changes in $P$.  This causal direction is already very important for understanding hydrology, and requires much exploration compared to what is already in the literature.\\
