...
\begin{equation}
FIXME \frac{dW}{dr} = \frac{\frac{ds_b}{dr} W(r) \left(W_r - W(r)\right) - \Big[\varphi_0\, r + \frac{dP_o}{dr} W(r)\Big] W(r)^{1/3} \left(W_r - W(r)\right)^{2/3}}{\frac{1}{3} W_r\, s_b(r) + \rho_w g W(r)^{4/3} \left(W_r - W(r)\right)^{2/3}}.
\label{eq:WradialODE}
\end{equation}
