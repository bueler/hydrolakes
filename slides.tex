...
\begin{frame}
  ...
  \begin{itemize}
    \item an equation is needed to determine the pressure!
...
\begin{center}
\medskip
\includegraphics[width=0.4\textwidth]{figs/hewitt-cartoon}
\medskip
\end{center}
    \end{itemize}
  \end{itemize}
...
\begin{frame}
  ...
  \item \dots even though I \emph{like} elliptic variational inequalities
