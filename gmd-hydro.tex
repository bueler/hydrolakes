...
\section{The transport-plus-storage problem} \label{app:transportstorage}
...
\section{Mass conservation scheme: positivity and stability} \label{app:positivestable}
