...
\subsection{Application of the model at whole ice sheet scale}

FIXME: show $m$ and $|\bv_b|$ for Greenland ice sheet on 2km grid

FIXME: show $W$ and $\Wtil$ and $P$ for Greenland

\subsection{Evidence for a relation $P(W)$}

FIXME:  text about F\&C equation \eqref{eq:PofWFC}

% FIXME: for now these were generated in
%   green-hydro/edrun/
% by
%   ./genfig.sh run3km/ex_distributed-decoupled.nc g3km.png
% but we want to get them from a higher quality run
\newcommand{\myheight}{2.0in}
\begin{figure*}[ht]
\mbox{\includegraphics[height=\myheight,keepaspectratio=true]{bin1-g3km} \, \includegraphics[height=\myheight,keepaspectratio=true]{bin10-g3km} \, \includegraphics[height=\myheight,keepaspectratio=true]{bin30-g3km}}
\mbox{\includegraphics[height=\myheight,keepaspectratio=true]{bin100-g3km} \,
\includegraphics[height=2.05in,keepaspectratio=true]{bin500-g3km}}
\caption{Scatter plots of $(W,P)$ for all cells at end of FIXME year steady-input simulation on a 3 km FIXME grid for the whole Greenland ice sheet.  Top row, left to right: $[1,10)$ m/a; $[10,30)$ m/a; $[30,100)$ m/a.  Bottom row: $[100,500)$ m/a; $[500,5000)$ m/a.  Colored by ice thickness, using a common color scale shown beside last figure.}
\label{fig:isPofW}
\end{figure*}
...
The first author was supported by NASA grant \#NNX13AM16G.  Constantine Khroulev helped with the PISM implementation, and discussions with Andy Aschwanden and Tim Bartholomaus were much appreciated.
