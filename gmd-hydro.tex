...
\item an englacial porosity regularization which is shown to allow a practical numerical model in which physically-motivated bounds $0\le P \le P_o$ hold at all times (sections \ref{sec:closures} and \ref{sec:num}).
\end{itemize}
