...
\end{equation}
Then \eqref{eq:steadyboundfirst} is equivalent to the condition $W\ge W_c$, where $W_c = W_r s_b^3/(s_b^3 + P_o^3)$ is a critical water amount.  If $W\ge W_c$ then
\begin{equation}
