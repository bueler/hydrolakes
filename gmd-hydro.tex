...
\affil[1]{Department of Mathematics and Statistics and Geophysical Institute, University of Alaska Fairbanks, Alaska, USA}
\affil[2]{Institute for Marine and Atmospheric Research Utrecht, The Netherlands\footnote{Current address: Department of Earth Sciences, Uppsala University, Sweden}}
...
\bibitem[{Andrews et~al.(2014)}]{Andrewsetal2014}
...
\hline
    ...
    $\delta$ & 0.02 &  & $N_{\text{til}}$ lower bound, as fraction of overburden pressure \\
    ...
    $W_{\text{til}}^{\text{max}}$ & $2\phantom{\Big|}$ & $\text{m}$ & maximum water in till \citep{BBssasliding} \\
    \hline
  \end{tabular}
 \label{tab:constants}
\end{table*}
...
\begin{figure}[ht]
\includegraphics[width=7.62cm,keepaspectratio=true]{Ntilfunctions}
...
\begin{figure}[ht]
\includegraphics[width=7.62cm,keepaspectratio=true]{exact-W-plot-onu}
...
\begin{figure}[ht]
\includegraphics[width=7.62cm,keepaspectratio=true]{exact-P-plot}
...
\begin{figure}[ht]
\includegraphics[width=7.62cm,keepaspectratio=true]{refineWPpism}
...
\begin{figure*}[ht]
\mbox{\includegraphics[height=8.64cm,keepaspectratio=true]{g2km-init-bmelt} \,
\includegraphics[height=8.64cm,keepaspectratio=true]{g2km-init-velbase-mag}}
...
\begin{figure*}[ht]
\mbox{\includegraphics[height=8.64cm,keepaspectratio=true]{routing-decoupled-tillwat} \,
\includegraphics[height=8.64cm,keepaspectratio=true]{routing-decoupled-bwat}}
...
\begin{figure*}[ht]
\includegraphics[height=6.86cm,keepaspectratio=true]{detail-routing-decoupled-bwat}
...
\begin{figure*}[ht]
\mbox{\includegraphics[height=8.64cm,keepaspectratio=true]{distributed-decoupled-bwat} \,
\includegraphics[height=8.64cm,keepaspectratio=true]{distributed-decoupled-bwprel}}
...
\begin{figure*}[ht]
\mbox{\includegraphics[height=4.57cm,keepaspectratio=true]{bin1-g2km} \, \includegraphics[height=4.57cm,keepaspectratio=true]{bin10-g2km} \, \includegraphics[height=4.57cm,keepaspectratio=true]{bin30-g2km}}
\mbox{\includegraphics[height=4.57cm,keepaspectratio=true]{bin100-g2km} \,
\includegraphics[height=4.70cm,keepaspectratio=true]{bin300-g2km}}
...
\begin{figure}[ht]
\includegraphics[width=7.11cm,keepaspectratio=true]{psteady-vb}
...
\begin{figure}[ht]
\includegraphics[width=7.11cm,keepaspectratio=true]{psteady-Po}
