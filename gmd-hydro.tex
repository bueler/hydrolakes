...
\end{align}
The equations use these derived functions:
\begin{align*}
...
\begin{table}[ht]
\caption{Functions in subglacial hydrology model \eqref{eq:bluebox}.}
\begin{tabular}{l|l}
