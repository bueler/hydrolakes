...
\subsection{Running the model at whole ice sheet scale}
...
\caption{Scatters plot of $(W,P)$ pairs for all cells at end of FIXME year steady-input simulation on a 2000 m grid for the whole Greenland ice sheet.  Top row, left to right: $[1,10)$ m/a; $[10,30)$ m/a; $[30,100)$ m/a.  Bottom row: $[100,500)$ m/a; $[500,5000)$ m/a.  Colored by ice thickness, using a common color scale shown beside last figure.}
\label{fig:isPofW}
\end{figure*}
