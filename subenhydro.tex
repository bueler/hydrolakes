...
Any reasonable dynamical model of the subglacial water layer under a glacier or ice sheet has at least these two elements: the mass of the water is conserved and the water flows from high to low hydraulic potential.  Water could be exchanged with a porous englacial system.  Physical processes also control the geometry of the cavities or conduits in which the water moves, including the opening of cavities by sliding of the overlying ice past bedrock bumps (i.e.~cavitation) and the closure of cavities and channels by creep.  These physical processes should combine to determine the local relationship between water amount and water pressure.  

This paper describes such a model for distributed systems of linked cavities with additional englacial storage.  The cavities open by sliding of the ice and they close by ice creep.  Channels are not, however, included in the model.  Wall melt is included as a contribution to the mass conservation equation but not in the cavity evolution equation.
