...
\begin{equation}
K(W,\grad P,\grad b) = k W^{\alpha-1} \left|\grad(P+\rho_w g b)\right|^{\beta - 2}.
\end{equation}
...
\begin{equation} \label{eq:vexpression}
  \bV = - \frac{K(W,\grad P,\grad b)}{\rho_w g}\, \grad \left(P + \rho_w g b\right)
\end{equation}
and the nonlinear diffusivity
\begin{equation} \label{eq:Dexpression}
  D = K(W,\grad P,\grad b)\, W.
\end{equation}
With this notation, equation \eqref{eq:firstfluxdecomp} is replaced by a cleaner decomposition of the flux,
...
Clearly the flux $\bq$ depends on the bedrock slope $\grad b$.  Because bedrock elevation is rough (irregular) data in practice, this part of the velocity $\bV$ may not be very smooth, and it may be large in magnitude.
