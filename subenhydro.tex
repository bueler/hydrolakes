...
We also model englacial water storage in a system of crevasses, cracks, veins, and/or moulins of unspecified morphology but with constant macroporosity $\phi$ \citep{Bartholomausetal2011}.  The case $\phi=0$ of no englacial storage is allowed; it may apply to cold glaciers and the interior of ice sheets.  The extension that $\phi$ varies in time and map-plane location is natural but it is not specifically considered here.  The mass of englacial water can be tracked with the elevation above the bed $z_{en}(t,x,y)$ for the top of the (notional) ``water table'' in the porous glacier.  In a column of the glacier with cross-sectional area $\Delta x \times \Delta y = \Delta a$ the volume of water is then $\phi\, \Delta a \, z_{en}$ \citep{Bartholomausetal2011}.  We can just as easily track the water by an effective thickness for the englacial water, however, and we define
\begin{equation}
