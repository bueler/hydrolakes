...
\end{equation}
Adding equations \eqref{eq:qexpression} and \eqref{eq:tilldynamics}, we have from \eqref{eq:ellipticone} a new relation between $W$, $\Wtil$, and $P$, namely
\begin{equation}
0 = \Div\left(K W \grad \psi\right) + \frac{m}{\rho_w} + \mathcal{C}(N,W) - \mathcal{O}(|\bv_b|,W) - \mu \left(\min\left\{\tau W,\Wtilmax\right\} - \Wtil\right). \label{eq:elliptictwo}
\end{equation}
...
\begin{equation}
\frac{\phi}{\rho_w g} \ddt{P} = \Div\left(K W \grad \psi\right) + \frac{m}{\rho_w} + \mathcal{C}(N,W) - \mathcal{O}(|\bv_b|,W) - \mu \left(\min\left\{\tau W,\Wtilmax\right\} - \Wtil\right). \label{eq:regpressureequation}
\end{equation}
