...
\end{align}
Step $\ast$ follows from \eqref{eq:abs:conservefd}.  Step $\dagger$ follows from noticing that the sums collapse though cancellation.  The four sums in the last line, in square brackets, are sums over the sides of the rectangle $R$, here starting in the lower-left and traversing counterclockwise.  One should compare \eqref{eq:abs:discreteconserve} to the continuum statement \eqref{eq:abs:continuumconserve}.
