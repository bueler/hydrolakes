...
The total effective thickness of the water at map-plane location $(x,y)$ and time $t$ is $W + \Wtil$.  We always assume the water thicknesses are nonnegative: $W \ge 0$ and $\Wtil \ge 0$.  The total thickness is conserved in our model.  In two map-plane dimensions the mass conservation equation is \citep{Clarke05}
...
%FIXME: fix the figure to not show the Bueler-Brown straight line
\medskip
