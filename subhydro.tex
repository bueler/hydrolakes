...
\tau_c &= c_0 + (\tan \varphi)\, \delta P_o \, 10^{(e_0/C_c) \left(1 - (\Wtil/\Wtilmax)\right)}. \notag
\end{empheq}
...
\end{empheq}
%FIXME:  does van der Wel et al 2013 use this model?
%FIXME:  if so, is N_0 there scaled with P_o
